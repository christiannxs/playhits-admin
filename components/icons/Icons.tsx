...
// Props for icons to allow className customization
type IconProps = {
  className?: string;
};
...
export const MoneyIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1.667a1.667 1.667 0 011.667-1.667h0a1.667 1.667 0 011.667 1.667v1.667M12 18v1.667a1.667 1.667 0 001.667 1.667h0a1.667 1.667 0 001.667-1.667V18m-6-6h.01M18 12h.01M6 12h.01M12 12h.01" />
    </svg>
);
...
export const PrinterIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H7a2 2 0 00-2 2v4a2 2 0 002 2h2m8 0v2a2 2 0 01-2 2H9a2 2 0 01-2-2v-2m8 0H9" />
  </svg>
);
...
export const CreditCardIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const LogoutIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M15.75 15l3.75-3.75M15.75 15l3.75 3.75M15.75 15H3" />
  </svg>
);
...
export const MusicNoteIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ClipboardCopyIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SquaresPlusIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
/** Ícone de sincronizar / puxar do Notion. */
export const CloudArrowDownIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
